...
func (m *ProviderMock) SelectAllPosts() ([]*entities.Post, error) {
	args := m.Called()
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *ProviderMock) SelectUserPosts(userId int) ([]*entities.Post, error) {
...
func (m *ProviderMock) GetCommentsForPost(postId int) ([]*entities.Comment, error) {
