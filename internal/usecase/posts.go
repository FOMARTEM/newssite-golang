...
// ListPosts
func (u *Usecase) ListPosts(limit int, offset int) ([]*entities.Post, error) {
  posts, err := u.p.SelectAllPosts(limit, offset)
  if err != nil {
    return nil, err
  }
...
func (u *Usecase) ListUserPosts(userId int, limit int, offset int) ([]*entities.Post, error) {
  posts, err := u.p.SelectUserPosts(userId, limit, offset)
  if err != nil {
    return nil, err
  }
